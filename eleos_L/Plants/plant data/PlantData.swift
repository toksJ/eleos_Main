...
var plantsData : [Plant] = [
    Plant(plantName: "Monstera", plantPic: "monstera icon",plantFullPic: "monstera2",plantMidPic: "",plantBabyPic: "", plantHeadline: "Vibrant greenery and iconic splits converge for a touch of natural artistry.",
    ...
    Plant(plantName: "Peace Lily", plantPic: "peace lily icon",
          plantFullPic: "peace lily2", plantMidPic: "",plantBabyPic: "", plantHeadline: "Elegant white blooms and lush foliage.",
    ...
    Plant(plantName: "Prayer Plant", plantPic: "Prayer plant icon",
          plantFullPic: "prayer plant2",plantMidPic: "",plantBabyPic: "", plantHeadline: "Delicately-patterned leaves that seem to dance with life.", plantDescription: "A perennial tropical plant that displays variegated oval-shaped leaves with smooth edges, which fold upward during the night, resembling hands held in prayer. these delicate plants thrive with frequent watering , so make sure to fulfill its water intake needs!", dropsNeeded: 50, waterIntake: 5),
